...
public class BookmarkDTO {
    ...
    private List<ColecaoDTO> colecoes = new ArrayList<>(); // Inicializando com uma lista vazia
    ...
    public void setColecoes(List<ColecaoDTO> colecoes) {
        this.colecoes = colecoes != null ? colecoes : new ArrayList<>(); // Garantindo que não seja null
    }
